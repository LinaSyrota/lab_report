...
namespace lab1_asd_s_
{
    class Program
    {
        ...
        //public static string contrBr(string s)
        //{
        //    int indexo = -1, indexc = -1;
        //    bool num = false;
        //    for (int x = indexo + 1; x < s.Length; x++) // пошук дужок у рядку
        //    {
        //        if (s.Substring(x, 1) == "(")
        //            indexo = x;
        //        if (s.Substring(x, 1) == ")")
        ...
        //    for (int x = indexo + 1; x < s.Substring(indexo + 1, s.Length - indexc + 1).Length; x++)
        //    {
        //        if (s.Substring(x, 1) == "-" || s.Substring(x, 1) == "+" || s.Substring(x, 1) == "*" || s.Substring(x, 1) == "/")
        //            num = true;
        //    }

        //    if (num == false && indexc < s.Length)
        //    {
        //        s = s.Remove(indexo, 1);
        //        s = s.Remove(indexc + 1, 1);
        //    }
        ...
        static double calculate(string s)
        {
            ...
            int indexqo = -1, indexqc = -1; // індекс дужки
